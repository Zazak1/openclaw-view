...
describe("iconForTab", () => {
  ...
  it("returns stable icons for known tabs", () => {
    ...
    expect(iconForTab("ops")).toBe("globe");
...
describe("titleForTab", () => {
  ...
  it("returns expected titles", () => {
    expect(titleForTab("chat")).toBe("消息与沟通");
    expect(titleForTab("overview")).toBe("服务概览");
    expect(titleForTab("ops")).toBe("运行态");
    expect(titleForTab("cron")).toBe("任务计划");
  });
});
...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    expect(subtitleForTab("chat")).toContain("客户沟通");
...
describe("TAB_GROUPS", () => {
  it("contains all expected groups", () => {
    ...
    expect(labels).toContain("客户使用场景");
